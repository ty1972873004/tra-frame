...
<body class="gray-bg">
    ...
    <!-- Flot -->
    <script src="${basePath}/resources/js/plugins/flot/jquery.flot.js"></script>
    <script src="${basePath}/resources/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="${basePath}/resources/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="${basePath}/resources/js/plugins/flot/jquery.flot.pie.js"></script>
    <!-- 自定义js -->
    <script src="${basePath}/resources/js/content.js"></script>
    <!--flotdemo-->
